...
%
%  27-10-2022
%   01.) changed order of [P,V,A] to [A,V,P] to accomodate R2022b
%==========================================================================
    ...
    methods
        ...
        function OBJ = calc_eom(OBJ, genF_OBJ)
            ...
            states_actual_list = [OBJ.actual_list_SYM_vel;
                                  OBJ.actual_list_SYM_pos  ];  % switched POS and VEL order for R2022b
                              
            % define the HOLDER symbol list
            states_holder_list = [OBJ.holder_list_SYM_vel;
                                  OBJ.holder_list_SYM_pos  ]; % switched POS and VEL order for R2022b
            ...
            OLD_list = [ OBJ.actual_list_SYM_acc;
                         OBJ.actual_list_SYM_vel;
                         OBJ.actual_list_SYM_pos ];  % switched POS,VEL,ACC order for R2022b
                     
            new_list = [ OBJ.holder_list_SYM_acc;
                         OBJ.holder_list_SYM_vel;
                         OBJ.holder_list_SYM_pos ]; % switched POS,VEL,ACC order for R2022b
